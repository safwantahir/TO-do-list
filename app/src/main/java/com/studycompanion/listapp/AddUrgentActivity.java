...
public class AddUrgentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_urgent_card);
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                UrgentModel newCard = new UrgentModel(cardName, cardNumberWithSpaces, userName, validThru, cvvCode);
